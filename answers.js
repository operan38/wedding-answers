...
const questions = [
  ...
  { answer: "жених", isJoke: false, color: BLUE }, // 7
  { answer: "карие", isJoke: false, color: ORANGE },
  { answer: "зелёные", isJoke: false, color: ORANGE },
  { answer: "запечённые ребрышки", isJoke: false, color: ORANGE },
  ...
  { answer: "бананы", isJoke: false, color: GREEN }, // 17
  { answer: "солянка", isJoke: false, color: GREEN }, 
  { answer: "жених", isJoke: true, color: GREEN, answerJoke: "Попались! На самом деле это невеста" },
  { answer: "зима", isJoke: false, color: GREEN },
  ...
  { answer: "торт Наполеон", isJoke: false, color: GREEN }, // 27
  { answer: "пельмени домашние", isJoke: false, color: YELLOW },
  { answer: "ящерица", isJoke: false, color: YELLOW },
  { answer: "ужасы", isJoke: false, color: YELLOW },
  ...
  { answer: "невеста", isJoke: false, color: YELLOW }, // 37
  { answer: "нуль", isJoke: false, color: RED },
  { answer: "дверь", isJoke: false, color: RED },
  { answer: "ночью", isJoke: false, color: RED },
  ...
  { answer: "Елена", isJoke: false, color: RED }, // 47
  { answer: "500 - 600 гр", isJoke: false, color: BLUE },
  { answer: "больше 1 метра", isJoke: false, color: BLUE },
  { answer: "42", isJoke: false, color: BLUE },
  ...
  { answer: "невеста", isJoke: false, color: BLUE },
  { answer: "жених", isJoke: false, color: ORANGE }, // 57
  { answer: "жених", isJoke: false, color: ORANGE },
